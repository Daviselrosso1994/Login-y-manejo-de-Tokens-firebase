...
class LoginPage extends StatelessWidget {
  ...
  //Para usar LoginBloc blo como argumento utilizamos la export del provider_InheritedWidget.dart
    ...
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        return RaisedButton(
          ...
          onPressed:
              snapshot.hasData ? () => _inicioSesion(context, bloc) : null,
        );
      },
    );
  }

  _inicioSesion(BuildContext context, LoginBloc bloc) {
    usuarioProvider.login(bloc.latestEmail, bloc.latestPassword);
  }
}
